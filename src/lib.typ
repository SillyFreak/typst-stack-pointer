...
/// -> array
#let step(
  /// exclusively named arguments to be added to the step
  /// -> dictionary
  ..args,
) = {
...
/// -> array
#let bare-l(
  /// the effects to apply before the next step, and the fields for the next step
  /// -> arguments
  ..args,
) = {
...
/// -> array
#let l(
  /// the line number to add to the step as a field
  /// -> integer
  line,
  /// the effects to apply before the next step, and the extra fields for the next step
  /// -> arguments
  ..args,
) = bare-l(line: line, ..args)
...
#let retval(
  ...
  /// -> any
  result,
) = ((type: "return-value", result: result),)
...
/// -> array
#let func(
  /// the name of the function; used for the call effect
  /// -> string
  name,
  /// the line at which the simulated function starts
  /// -> int
  first-line,
  /// simulates the function, receives an `l()`-like function
  /// -> function
  callback,
) = {
